...
namespace Payroll.Data.QuickBase
{
	...
	/// </summary>
	public class RanchPayrollAdjustmentRepo : QuickBaseRepo<RanchAdjustmentLine>
	{
		...
		/// <summary>
		/// Returns a property formatted clist string for API_DoQuery calls to the Ranch Payroll Adjustment table in Quick Base.
		/// </summary>
		/// <returns></returns>
