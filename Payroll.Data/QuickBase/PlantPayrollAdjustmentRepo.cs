...
namespace Payroll.Data.QuickBase
{
	...
	public class PlantPayrollAdjustmentRepo : QuickBaseRepo<PlantAdjustmentLine>, IPlantPayrollAdjustmentRepo
	{
			...
			foreach (var record in records)
			{
				...
				foreach (var field in fields)
				{
					...
					switch (fieldId)
					{
						...
						case (int)PlantPayrollAdjustmentField.PositionTitle: temp.PositionTitle = field.Value.ToUpper().Trim(); break;
		...
		private string GetDoQueryClist()
		{
			...
			sb.Append($"{(int)PlantPayrollAdjustmentField.PositionTitle}.");
