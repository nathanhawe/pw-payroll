...
{
	public partial class AddPlantAdjustmentLines : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			migrationBuilder.CreateTable(
				name: "PlantAdjustmentLines",
				columns: table => new
				{
					...
					GrossFromIncentive = table.Column<decimal>(nullable: false),
					...
					IsH2A = table.Column<bool>(nullable: false),
				...
				constraints: table =>
				{
					table.PrimaryKey("PK_PlantAdjustmentLines", x => x.Id);
				});
		}
