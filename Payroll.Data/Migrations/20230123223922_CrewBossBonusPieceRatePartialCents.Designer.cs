...
namespace Payroll.Data.Migrations
{
    ...
    [Migration("20230123223922_CrewBossBonusPieceRatePartialCents")]
    partial class CrewBossBonusPieceRatePartialCents
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Payroll.Domain.CrewBossBonusPieceRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("PerTreeBonus")
                        .HasColumnType("decimal(18,3)");

                    b.HasKey("Id");

                    b.ToTable("CrewBossBonusPieceRates");
                });
            ...
            modelBuilder.Entity("Payroll.Domain.CrewBossPayLine", b =>
                {
                    ...
                    b.Property<bool>("HighHeatSupplement")
                        .HasColumnType("bit");

                    b.Property<decimal>("HighHeatSupplementTotalHoursCap")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<bool>("IsDisqualifiedFromQualityBonus")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Payroll.Domain.CulturalLaborWage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Payroll.Domain.PlantAdjustmentLine", b =>
                {
                    ...
                    b.Property<decimal>("SickLeaveRequested")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Payroll.Domain.PlantPayLine", b =>
                {
                    ...
                    b.Property<int>("PackerNumber")
                        .HasColumnType("int");

                    b.Property<string>("Packline")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Payroll.Domain.RanchBonusPieceRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("PerHourThreshold")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("RanchBonusPieceRates");
                });

            modelBuilder.Entity("Payroll.Domain.RanchGroupBonusPieceRate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("PerVesselBonus")
                        .HasColumnType("decimal(18,2)");

                    b.HasKey("Id");

                    b.ToTable("RanchGroupBonusPieceRates");
                });
            ...
            modelBuilder.Entity("Payroll.Domain.RanchPayLine", b =>
                {
                    ...
                    b.Property<bool>("IsLayoffTagFirstOfTwoInWeek")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Payroll.Domain.SouthCrewBossWage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DateModified = new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EffectiveDate = new DateTime(2021, 2, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            Wage = 24.75m,
                            WorkerCountThreshold = 19
                        },
