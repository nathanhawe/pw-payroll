...
namespace Payroll.Infrastructure.Authorization
{
	public class SubjectMustMatchUserHandler : AuthorizationHandler<SubjectMustMatchUserRequirement>
	{
		...
		public SubjectMustMatchUserHandler(IHttpContextAccessor httpContextAccessor)
		{
			_httpContextAccessor = httpContextAccessor ?? throw new ArgumentNullException(nameof(httpContextAccessor));
		}

		protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, SubjectMustMatchUserRequirement requirement)
		{
