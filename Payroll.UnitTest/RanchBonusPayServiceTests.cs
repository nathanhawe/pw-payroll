...
namespace Payroll.UnitTest
{
	...
	public class RanchBonusPayServiceTests
	{
		...
		public void CreatesCorrectIndividualBonusRecordsByBlock()
		{
			...
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 28 && x.PieceRate == 2 && x.OtherGross == 0 && x.GrossFromPieces == 56 && x.TotalGross == 56).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 14 && x.PieceRate == 2.1M && x.OtherGross == 0 && x.GrossFromPieces == 29.4M && x.TotalGross == 29.4M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == wednesday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 28 && x.PieceRate == 2.2M && x.OtherGross == 0 && x.GrossFromPieces == 61.6M && x.TotalGross == 61.6M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 26 && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 52 && x.TotalGross == 52M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == friday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 19.5M && x.PieceRate == 2.1M && x.OtherGross == 0 && x.GrossFromPieces == 40.95M && x.TotalGross == 40.95M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 26 && x.PieceRate == 2.2M && x.OtherGross == 0 && x.GrossFromPieces == 57.2M && x.TotalGross == 57.2M).Count());
			...
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == .34M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == .68M && x.TotalGross == .68M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group3 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 1.66M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 3.32M && x.TotalGross == 3.32M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == .99M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 1.98M && x.TotalGross == 1.98M).Count());


			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 1.5M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 3 && x.TotalGross == 3M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group3 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 2.5M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 5 && x.TotalGross == 5M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == wednesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 3M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 6 && x.TotalGross == 6M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == wednesday && x.BlockId == group3 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 2.5M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 5 && x.TotalGross == 5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == wednesday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 2M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 4 && x.TotalGross == 4M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 1.5M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 3 && x.TotalGross == 3M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group3 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 5M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 10 && x.TotalGross == 10M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 2M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 4 && x.TotalGross == 4M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == friday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 1.5M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 3 && x.TotalGross == 3M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == friday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 2M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 4 && x.TotalGross == 4M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 1.5M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 3 && x.TotalGross == 3M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group3 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 2.5M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 5 && x.TotalGross == 5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Thinning && x.Pieces == 4M && x.PieceRate == 2M && x.OtherGross == 0 && x.GrossFromPieces == 8 && x.TotalGross == 8M).Count());
			...
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.PieceRatePruningWinter && x.Pieces == 5M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 1.25M && x.TotalGross == 1.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group3 && x.LaborCode == (int)RanchLaborCode.PieceRatePruningSummer && x.Pieces == 5M && x.PieceRate == .15M && x.OtherGross == 0 && x.GrossFromPieces == .75M && x.TotalGross == .75M).Count());
			...
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group3 && x.LaborCode == (int)RanchLaborCode.PieceRatePruningSummer && x.Pieces == 5M && x.PieceRate == .15M && x.OtherGross == 0 && x.GrossFromPieces == .75M && x.TotalGross == .75M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == wednesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.PieceRatePruningWinter && x.Pieces == 5M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 1.25M && x.TotalGross == 1.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == wednesday && x.BlockId == group3 && x.LaborCode == (int)RanchLaborCode.PieceRatePruningSummer && x.Pieces == 5M && x.PieceRate == .15M && x.OtherGross == 0 && x.GrossFromPieces == .75M && x.TotalGross == .75M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.PieceRatePruningWinter && x.Pieces == 5M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 1.25M && x.TotalGross == 1.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group3 && x.LaborCode == (int)RanchLaborCode.PieceRatePruningSummer && x.Pieces == 5M && x.PieceRate == .15M && x.OtherGross == 0 && x.GrossFromPieces == .75M && x.TotalGross == .75M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == friday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.PieceRatePruningWinter && x.Pieces == 5M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 1.25M && x.TotalGross == 1.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == friday && x.BlockId == group3 && x.LaborCode == (int)RanchLaborCode.PieceRatePruningSummer && x.Pieces == 5M && x.PieceRate == .15M && x.OtherGross == 0 && x.GrossFromPieces == .75M && x.TotalGross == .75M).Count());
		...
		[TestMethod]
		public void CreatesCorrectIndividualWinterPruningBonusRecords()
		{
			var dbName = "CreatesCorrectIndividualWinterPruningBonusRecords";
			var options = new DbContextOptionsBuilder<PayrollContext>()
				.UseInMemoryDatabase(databaseName: dbName)
				.Options;
			...
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());

			/* Tuesday - All crew South */
			Assert.AreEqual(8, results.Where(x => x.BatchId == batch.Id && x.ShiftDate == tuesday && x.WeekEndDate == weekEndDate).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeD && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeD && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			...
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 1000M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 250M && x.TotalGross == 250M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 1000M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 250M && x.TotalGross == 250M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 5M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 1.25M && x.TotalGross == 1.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeD && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 3M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 0.75M && x.TotalGross == 0.75M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());

			/* Friday */
			Assert.AreEqual(2, results.Where(x => x.BatchId == batch.Id && x.ShiftDate == friday && x.WeekEndDate == weekEndDate).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == friday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 15M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 3.75M && x.TotalGross == 3.75M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == friday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 5M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 1.25M && x.TotalGross == 1.25M).Count());

			/* Saturday - TD South */
			Assert.AreEqual(6, results.Where(x => x.BatchId == batch.Id && x.ShiftDate == saturday && x.WeekEndDate == weekEndDate).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 1000M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 250M && x.TotalGross == 250M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 1000M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 250M && x.TotalGross == 250M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 15M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 3.75M && x.TotalGross == 3.75M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 5M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 1.25M && x.TotalGross == 1.25M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 25M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 6.25M && x.TotalGross == 6.25M).Count());

			/* Sunday */
			Assert.AreEqual(2, results.Where(x => x.BatchId == batch.Id && x.ShiftDate == weekEndDate && x.WeekEndDate == weekEndDate).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == weekEndDate && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 50M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 12.5M && x.TotalGross == 12.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeD && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == weekEndDate && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Winter && x.Pieces == 7M && x.PieceRate == .25M && x.OtherGross == 0 && x.GrossFromPieces == 1.75M && x.TotalGross == 1.75M).Count());
		...
		[TestMethod]
		public void CreatesCorrectIndividualSummerPruningBonusRecords()
		{
			var dbName = "CreatesCorrectIndividualSummerPruningBonusRecords";
			var options = new DbContextOptionsBuilder<PayrollContext>()
				.UseInMemoryDatabase(databaseName: dbName)
				.Options;
			...
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == monday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());

			/* Tuesday - All crew South */
			Assert.AreEqual(8, results.Where(x => x.BatchId == batch.Id && x.ShiftDate == tuesday && x.WeekEndDate == weekEndDate).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeD && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeD && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == tuesday && x.BlockId == group2 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			...
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 1000M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 100M && x.TotalGross == 100M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 1000M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 100M && x.TotalGross == 100M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 5M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 0.5M && x.TotalGross == 0.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeD && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 3M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 0.3M && x.TotalGross == 0.3M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == thursday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());

			/* Friday */
			Assert.AreEqual(2, results.Where(x => x.BatchId == batch.Id && x.ShiftDate == friday && x.WeekEndDate == weekEndDate).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == friday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 15M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 1.5M && x.TotalGross == 1.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == friday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 5M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 0.5M && x.TotalGross == 0.5M).Count());

			/* Saturday - TD South */
			Assert.AreEqual(6, results.Where(x => x.BatchId == batch.Id && x.ShiftDate == saturday && x.WeekEndDate == weekEndDate).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 1000M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 100M && x.TotalGross == 100M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group1 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 1000M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 100M && x.TotalGross == 100M).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeA && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeB && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 15M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 1.5M && x.TotalGross == 1.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 5M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 0.5M && x.TotalGross == 0.5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeLightDuty && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == saturday && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 25M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 2.5M && x.TotalGross == 2.5M).Count());

			/* Sunday */
			Assert.AreEqual(2, results.Where(x => x.BatchId == batch.Id && x.ShiftDate == weekEndDate && x.WeekEndDate == weekEndDate).Count());

			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeC && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == weekEndDate && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 50M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 5M && x.TotalGross == 5M).Count());
			Assert.AreEqual(1, results.Where(x => x.BatchId == batch.Id && x.EmployeeId == employeeD && x.PayType == PayType.ProductionIncentiveBonus && x.ShiftDate == weekEndDate && x.BlockId == group4 && x.LaborCode == (int)RanchLaborCode.Pruning_Summer && x.Pieces == 7M && x.PieceRate == .10M && x.OtherGross == 0 && x.GrossFromPieces == 0.7M && x.TotalGross == 0.7M).Count());
