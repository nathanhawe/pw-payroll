...
namespace Payroll.UnitTest
{
	...
	public class CrewBossPayServiceTests
	{
		...
		public void CreatesRanchPayLines_OnOrAfter20210208()
		{
			...
			Assert.AreEqual(4, ranchPayLines.Count());
			Assert.AreEqual(1, ranchPayLines.Where(x => x.BatchId == 1 && x.EmployeeId == "TestHourlyTrees" && x.ShiftDate == new DateTime(2021, 2, 8) && x.Crew == 1 && x.HoursWorked == 10 && x.HourlyRate == 0M && x.GrossFromHours == 0 && x.GrossFromPieces == 0 && x.OtherGross == 215 && x.PayType == PayType.CBHourlyTrees && !x.FiveEight).Count());
			Assert.AreEqual(1, ranchPayLines.Where(x => x.BatchId == 1 && x.EmployeeId == "TestHourlyVines" && x.ShiftDate == new DateTime(2021, 2, 8) && x.Crew == 2 && x.HoursWorked == 10 && x.HourlyRate == 0M && x.GrossFromHours == 0 && x.GrossFromPieces == 0 && x.OtherGross == 215 && x.PayType == PayType.CBHourlyVines && !x.FiveEight).Count());
			Assert.AreEqual(1, ranchPayLines.Where(x => x.BatchId == 1 && x.EmployeeId == "TestSouthHourly" && x.ShiftDate == new DateTime(2021, 2, 8) && x.Crew == 3 && x.HoursWorked == 10 && x.HourlyRate == 0M && x.GrossFromHours == 0 && x.GrossFromPieces == 0 && x.OtherGross == 247.5M && x.PayType == PayType.CBSouthHourly && x.FiveEight).Count());
			Assert.AreEqual(1, ranchPayLines.Where(x => x.BatchId == 1 && x.EmployeeId == "TestSouthDaily" && x.ShiftDate == new DateTime(2021, 2, 8) && x.Crew == 4 && x.HoursWorked == 10 && x.HourlyRate == 0M && x.GrossFromHours == 0 && x.GrossFromPieces == 0 && x.OtherGross == 247.5M && x.PayType == PayType.CBSouthDaily && !x.FiveEight).Count());
		}
		...
		public void CreatesRanchPayLines_OnOrAfter20210531()
		{
			...
			Assert.AreEqual(1, ranchPayLines.Where(x => x.BatchId == 1 && x.EmployeeId == "TestHourlyTrees" && x.ShiftDate == new DateTime(2021, 5, 31) && x.Crew == 1 && x.HoursWorked == 5.5M && x.HourlyRate == 0M && x.GrossFromHours == 0 && x.GrossFromPieces == 0 && x.OtherGross == 118.25M && x.PayType == PayType.CBHourlyTrees && !x.FiveEight).Count());
			Assert.AreEqual(1, ranchPayLines.Where(x => x.BatchId == 1 && x.EmployeeId == "TestHourlyVines" && x.ShiftDate == new DateTime(2021, 5, 31) && x.Crew == 2 && x.HoursWorked == 5.5M && x.HourlyRate == 0M && x.GrossFromHours == 0 && x.GrossFromPieces == 0 && x.OtherGross == 118.25M && x.PayType == PayType.CBHourlyVines && !x.FiveEight).Count());
			Assert.AreEqual(1, ranchPayLines.Where(x => x.BatchId == 1 && x.EmployeeId == "TestSouthHourly" && x.ShiftDate == new DateTime(2021, 5, 31) && x.Crew == 3 && x.HoursWorked == 5.5M && x.HourlyRate == 0M && x.GrossFromHours == 0 && x.GrossFromPieces == 0 && x.OtherGross == 136.13M && x.PayType == PayType.CBSouthHourly && x.FiveEight).Count());
			Assert.AreEqual(1, ranchPayLines.Where(x => x.BatchId == 1 && x.EmployeeId == "TestSouthDaily" && x.ShiftDate == new DateTime(2021, 5, 31) && x.Crew == 4 && x.HoursWorked == 5.5M && x.HourlyRate == 0M && x.GrossFromHours == 0 && x.GrossFromPieces == 0 && x.OtherGross == 136.13M && x.PayType == PayType.CBSouthDaily && !x.FiveEight).Count());
