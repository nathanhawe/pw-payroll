...
namespace Payroll.UnitTest
{
	...
	public class PlantMinimumMakeUpCalculatorTests
	{
		...
		private PlantMinimumMakeUpCalculator _minimumMakeUpCalculator;

		[TestInitialize]
		public void Setup()
		{
			_minimumMakeUpCalculator = new PlantMinimumMakeUpCalculator(_roundingService);
		}
	...
	[TestMethod]
		public void EffectiveRateIsLessThanMinimum_GenerateMinimumMakeUps()
		{
			...
			Assert.AreEqual(1, minimumMakeUps.Where(x => x.EmployeeId == "Employee3" && x.Gross == .4M).Count());
		}
