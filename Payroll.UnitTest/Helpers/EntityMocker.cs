...
namespace Payroll.UnitTest.Helpers
{
	public static class EntityMocker
	{
		...
		public static CrewBossPayLine MockCrewBossPayLine(
			...
			bool isDisqualifiedFromQualityBonus = false)
		{
			dateCreated ??= DateTime.Now;
			dateModified ??= DateTime.Now;
			weekEndDate ??= new DateTime(2020, 1, 5);
			...
			return new CrewBossPayLine
			{
				...
				IsDisqualifiedFromQualityBonus = isDisqualifiedFromQualityBonus,
			};
		}
		...
		public static CulturalLaborWage MockCulturalLaborWage(
			int id = 0,
			DateTime? dateCreated = null,
			DateTime? dateModified = null,
			bool isDeleted = false,
		...
		public static RanchBonusPieceRate MockRanchBonusPieceRate(
			int id = 0,
			DateTime? dateCreated = null,
			DateTime? dateModified = null,
			bool isDeleted = false,
			...
			string designation = "")
		{
			...
			return new RanchBonusPieceRate
			{
				Id = id,
				DateCreated = dateCreated.Value,
				DateModified = dateModified.Value,
			...
			decimal perTreeBonus = 0)
		{
			...
			return new CrewBossBonusPieceRate
			{
				Id = id,
				DateCreated = dateCreated.Value,
				DateModified = dateModified.Value,
