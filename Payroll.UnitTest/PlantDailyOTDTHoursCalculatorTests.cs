...
namespace Payroll.UnitTest
{
	...
	{
		private PlantDailyOTDTHoursCalculator _plantDailyOTDTHoursCalculator = new PlantDailyOTDTHoursCalculator();
		...
		public void SeventhDay_OverTimeUpToEightHours()
		{
			var dailySummaries = new List<DailySummary>
			{
				...
				new DailySummary{ Crew = (int)Plant.Reedley, EmployeeId = "Employee2", WeekEndDate = new DateTime(2020, 2, 23), ShiftDate = new DateTime(2020, 2, 23), TotalHours = 8, OverTimeHours = 0, DoubleTimeHours = 0}
			};
			...
			Assert.AreEqual(1, dailySummaries.Where(x => x.EmployeeId == "Employee2" && x.ShiftDate == new DateTime(2020, 2, 23) && x.OverTimeHours == 0).Count());
		}
